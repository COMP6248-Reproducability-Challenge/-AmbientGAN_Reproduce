...
parser.add_argument('--measurement', dest='measurement', default='block_pixels_patch', help='measurement function')
parser.add_argument('--prob', dest='prob', default=0.1, help='probability') # "prob" percentage of detail will be kept
parser.add_argument('--patch_size', dest='patch_size', default=14, help='patch size')
