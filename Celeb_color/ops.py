...
def load_train_data(args):
	paths = os.path.join(args.data, "img_align_celeba_block_patch_inpaint/*.jpg")
	...
	images = tf.image.central_crop(images, 1)
...
def img_tile2(epoch, args, imgs, aspect_ratio=1.0, tile_shape=None, border=1, border_color=0):
	if imgs.ndim != 3 and imgs.ndim != 4:
		raise ValueError('imgs has wrong number of dimensions.')
	n_imgs = imgs.shape[0]
